...
const menuItems = [
  ...
  { icon: Users, label: "Generate DM", path: "/generate" },
  { icon: LayoutDashboard, label: "History", path: "/history" },
      ...
      <div className="relative" ref={sidebarRef}>
        ...
        >
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center justify-between px-2 transition-all w-full gap-2">
              <div
